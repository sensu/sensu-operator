...
func init() {
	flag.BoolVar(&createCRD, "create-crd", true, "The backup operator will not create the SensuBackup CRD when this flag is set to false.")
	flag.Parse()
}
...
func main() {
	...
	logrus.Infof("sensu-backup-operator Version: %v", version.Version)
