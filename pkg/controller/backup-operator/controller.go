...
func (b *Backup) run(ctx context.Context) {
	...
	b.queue = workqueue.NewNamedRateLimitingQueue(workqueue.DefaultControllerRateLimiter(), "sensu-backup-operator")
	b.indexer, b.informer = cache.NewIndexerInformer(source, &api.SensuBackup{}, 0, cache.ResourceEventHandlerFuncs{
		AddFunc:    b.onAdd,
