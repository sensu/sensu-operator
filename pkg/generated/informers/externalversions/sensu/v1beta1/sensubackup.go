...
import (
	...
	sensu_v1beta1 "github.com/kinvolk/sensu-operator/pkg/apis/sensu/v1beta1"
	versioned "github.com/kinvolk/sensu-operator/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/kinvolk/sensu-operator/pkg/generated/informers/externalversions/internalinterfaces"
	v1beta1 "github.com/kinvolk/sensu-operator/pkg/generated/listers/sensu/v1beta1"
...
func (f *sensuBackupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&sensu_v1beta1.SensuBackup{}, f.defaultInformer)
}
